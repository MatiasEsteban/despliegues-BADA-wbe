// src/events/eventCoordinator.js
...
export class EventCoordinator {
    constructor(dataStore, renderer) {
        ...
        console.log('🎯 EventCoordinator inicializado');
    }

    // IMPORTANTE: El nombre del método debe ser setupEventListeners
    setupEventListeners() {
    ...
    setupSaveChangesButton() {
        ...
        let existingBtn = document.getElementById('btn-save-changes');
        if (existingBtn) existingBtn.remove();

        const saveButton = document.createElement('button');
        saveButton.id = 'btn-save-changes';
        saveButton.className = 'btn-save-changes hidden';
        ...
        this.dataStore.subscribeToChanges((changes) => {
            ...
            if (count > 0) {
                ...
                saveButton.querySelector('.changes-count').textContent = count;
            } else {
